<template>
    <v-app id="inspire" dark app>
        ...
        <div v-if="!route().current('welcome') && !route().current('login') && !route().current('register') && !route().current('password.request') && !route().current('password.reset')">
            ...
            <v-main :class="route().current('welcome') || route().current('login') || route().current('register') || route().current('password.request') || route().current('password.reset') ? 'background-color : blue' :  'background-color : none'">
